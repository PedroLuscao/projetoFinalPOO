...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    public void atualizarTabela(){
        ...
        Receita receita2 = new Receita(200.0, LocalDate.now(), TipoReceita.OUTRAS_RECEITAS);
        control.addListaLancamentos(receita1);
        control.addListaLancamentos(receita2);
        
        Despesa despesa1 = new Despesa(50.0, LocalDate.now(), TipoDespesa.ALIMENTACAO);
        Despesa despesa2 = new Despesa(450.0, LocalDate.now(), TipoDespesa.ENTRETENIMENTO);
        control.addListaLancamentos(despesa1);
        ...
        for(int i = 0; i < control.getListaLancamentos().size(); i++){
            if (control.getListaLancamentos().get(i) instanceof Receita){
                rowData[0] = "Receita";
                rowData[1] = control.getListaLancamentos().get(i).getValor();
                rowData[2] = control.getListaLancamentos().get(i).getDataLancamento();
                rowData[3] = ((Receita) control.getListaLancamentos().get(i)).getTipoReceita();
            }
            if (control.getListaLancamentos().get(i) instanceof Despesa){
                rowData[0] = "Despesa";
                rowData[1] = control.getListaLancamentos().get(i).getValor();
                rowData[2] = control.getListaLancamentos().get(i).getDataLancamento();
                rowData[3] = ((Despesa) control.getListaLancamentos().get(i)).getTipoDespesa();
            }
